> 🚧 Under Construction: This is a copy of https://raw.githubusercontent.com/material-components/material-components-web/master/docs/code/architecture.md that needs to be changed to suit the web-ams approach 🚧
